...
.PHONY: all help clean test test-rocm test-glm53-kda-rocm test-metal-session-batch test-mxfp4-cuda test-mxfp4-rocm test-cuda-session-batch test-cuda-mixed-batch dspark-acceptance dspark-verify-depth mtp-verify-depth cpu cuda cuda-spark cuda-generic cuda-regression strix-halo rocm test-cpu
...
ds4_agent_server.o: ds4_agent_server.c ds4.h ds4_ssd.h ds4_distributed.h ds4_tp.h ds4_help.h ds4_gpu_args.h ds4_agent_proto.h ds4_agent_utils.h
	$(CC) $(CFLAGS) -c -o $@ ds4_agent_server.c

ds4_agent_server_cpu.o: ds4_agent_server.c ds4.h ds4_ssd.h ds4_distributed.h ds4_tp.h ds4_help.h ds4_gpu_args.h ds4_agent_proto.h ds4_agent_utils.h
	$(CC) $(CFLAGS) -DDS4_NO_GPU -c -o $@ ds4_agent_server.c
